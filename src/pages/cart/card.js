  ...
  return (
    <fieldset className={styles.cardField}>
      ...
      <div className={styles.card}>
        ...
        <input type="text" name="number" value={state.number} onChange={handleInputChange} onFocus={handleInputFocus} />
        ...
        <input className={styles.expiry} type="text" name="expiry" value={state.expiry} onChange={handleInputChange} onFocus={handleInputFocus} />
        <label className={styles.cvcLabel} htmlFor="number">
          CVC
        </label>
        <input className={styles.cvcNumber} type="text" name="cvc" value={state.cvc} onChange={handleInputChange} onFocus={handleInputFocus} />
      </div>
    </fieldset>
  );
};
